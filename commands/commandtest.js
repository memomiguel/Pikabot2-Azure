...
exports.commands = {
	...
	this.reply('/tour autodq 2');
     ...
     dssb: function () {
	if (!this.can("info")) return;
	this.reply('/etour gen8dawnsuperstaffbros');
	this.reply('/tour autodq 2');
	},
     dssbcc1v1: function () {
	if (!this.can("info")) return;
	this.reply('/etour gen8dawnsuperstaffbroschallengecup1v1');
	this.reply('/tour autodq 2');
	},
     redo: function () {
	if (!this.can("info")) return;
	...
	this.reply('/tour autodq 2');
     ...
     azuremonsdoubles: function (arg, room, user) {
        if (!this.can("info")) return;
	this.reply('/etour Azuremons Random Doubles Battle');
	this.reply('/tour autodq 2');
	},
