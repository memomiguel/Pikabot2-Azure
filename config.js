...
exports.rooms = ['pikachuvalley','izukuslair','codersheaven','Neptune','Hydrocity','firebarsleague','thecelestialleague','theaphroleague','rockethq','monotype','tournaments','1v1','lobby'];
...
exports.pmhelp = "Hi #USER! I am memomiguel`s robot, here is the list of commands: https://pastebin.com/9v4VgTpk";
...
exports.maxBattles = 2;

exports.initBattleMsg = ['Good luck and have fun! feelsPika'];

exports.winmsg = ['Good game, but i won this battle bitchPls'];

exports.losemsg = ['Well played pikawink'];
