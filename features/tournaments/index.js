...
exports.parse = function (room, message, isIntro, spl) {
	...
	switch (spl[1]) {
		...
		case 'end':
			...
			Bot.say('pikachuvalley', 'Congratulations to' + lbData.winner + 'for winning the tournament! They receive 100 points. Runner-up ' + lbData.finalist + ' receives 40 points!');
